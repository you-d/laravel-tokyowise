...
class RensaiController extends BaseController {
	...
	/* A helper function for both the rensai(), rensaiCms(), & RensaiCategoryApiController's index() functions */
	...
	/* A helper function for the rensai(), rensaiCms(), & RensaiCategoryApiController's showPosts() functions	*/
	...
	/* A helper function for the RensaiPostApiController's show() function */
	protected function rensaiPostGetRecordDbQuery($postId) {
		$rensaiPost = RensaiPost::find($postId);
		return $rensaiPost;
	}
